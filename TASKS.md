...
18. Ввести SLA-поля задачи и авто-эскалацию при `Blocked > threshold`.
19. Добавить журнал действий оператора (кто и что изменил по задачам).
20. Добавить интеграционные тесты на lifecycle задачи и эскалации.
...
29. Провести нагрузочное профилирование control-center endpoint’ов.
30. Зафиксировать runbook эксплуатации и инцидентные сценарии.
